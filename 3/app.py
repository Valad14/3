...
# --- 1. НАСТРОЙКИ СТРАНИЦЫ И СВЕТЛЫЙ ИНТЕРФЕЙС ---
st.set_page_config(
...
st.markdown(
    ...
    <style>
    :root {
        --corpus-accent: #2563eb;
        --corpus-accent-soft: #dbeafe;
        --corpus-accent-2: #7c3aed;
        --corpus-border: #e5e7eb;
        --corpus-border-strong: #cbd5e1;
        --corpus-text: #111827;
        --corpus-muted: #4b5563;
        --corpus-bg: #ffffff;
        --corpus-surface: #ffffff;
        --corpus-soft: #f8fafc;
    ...
    .stApp {
        background: var(--corpus-bg) !important;
    ...
    .hero-card {
        ...
        border-radius: 24px;
        color: var(--corpus-text);
        background: var(--corpus-surface);
        box-shadow: 0 18px 46px rgba(15, 23, 42, 0.08);
        border: 1px solid var(--corpus-border);
    ...
    [data-testid="stSidebar"] {
        background: var(--corpus-surface) !important;
        border-right: 1px solid var(--corpus-border);
        color: var(--corpus-text);
    }

    [data-testid="stSidebar"] * {
        color: var(--corpus-text) !important;
    }

    [data-testid="stSidebar"] [data-testid="stFileUploaderDropzone"] {
        background: var(--corpus-soft);
        border: 2px dashed var(--corpus-border-strong);
        border-radius: 18px;
    }
    ...
    [data-testid="stSidebar"] textarea {
        background: var(--corpus-surface) !important;
        border-color: var(--corpus-border-strong) !important;
        color: var(--corpus-text) !important;
    ...
    div[data-testid="stMetric"] {
        background: var(--corpus-surface) !important;
        border: 1px solid var(--corpus-border) !important;
    ...
    section.main div[data-testid="stExpander"] details summary {
        ...
        border-bottom: 1px solid var(--corpus-border) !important;
    ...
    div[data-testid="stMetric"] {
        padding: 16px 18px;
        border-left: 6px solid var(--corpus-accent) !important;
    }

    div[data-testid="stMetric"] label {
        color: var(--corpus-muted) !important;
        font-weight: 800;
    }
    ...
    button[kind="primary"] {
        border: 1px solid var(--corpus-accent) !important;
        border-radius: 999px !important;
        color: white !important;
        font-weight: 900 !important;
        background: var(--corpus-accent) !important;
    ...
    [data-testid="stDataFrame"] div[role="columnheader"] {
        background: var(--corpus-soft) !important;
        color: var(--corpus-text) !important;
        font-weight: 900 !important;
        border-bottom: 1px solid var(--corpus-border) !important;
    }
    ...
    .context-box {
        ...
        margin: 12px 0;
        border: 1px solid var(--corpus-border);
        border-left: 6px solid var(--corpus-accent);
        box-shadow: 0 14px 34px rgba(15, 23, 42, 0.06);
        color: var(--corpus-text);
    }

    .context-highlight {
        background: var(--corpus-accent-soft);
        color: var(--corpus-text);
        padding: 4px 10px;
        border-radius: 999px;
        font-weight: 900;
    ...
    .instruction-note {
        ...
        margin: 10px 0;
        border: 1px solid var(--corpus-border);
        border-left: 6px solid var(--corpus-accent-2);
    }
...
st.markdown(
    ...
    <div class="hero-card">
        ...
        <p class="hero-subtitle">
            Светлый интерфейс для загрузки XML-TEI, автоматического выравнивания списков,
            просмотра контекста, редактирования типов разночтений и экспорта результатов.
        </p>
        <div class="bright-pill-row">
            <span class="bright-pill">⚪ светлая тема</span>
